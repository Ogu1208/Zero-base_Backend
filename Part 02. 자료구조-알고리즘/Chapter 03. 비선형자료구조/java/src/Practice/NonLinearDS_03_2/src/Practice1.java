...
class AVLTree {
    ...
    public Node rightRotate(Node node) {   // LL 회전
    ...
    public Node leftRotate(Node node) {     // RR 회전
    ...
    public int getBalance(Node node) {
        ...
        return height(node.left) - height(node.right);  // 좌우 높이 차이이
    }
    ...
    public Node insert(Node node, int key) {
        ...
        int balance = getBalance(node);  // 높이 차이 구하기
